...
public final class DamageAPIHelper {
     ...
     */
    public static @Nonnull DamageAPIHelper get() {
        return inst;
    }
    private static final @Nonnull DamageAPIHelper inst = new DamageAPIHelper();
     ...
     * @throws NullPointerException if event is null
     */
    public @Nullable DamageInfo setEventDamageInfo(@Nonnull org.bukkit.event.entity.EntityDamageEvent event, @Nullable DamageInfo info) {
        Preconditions.checkNotNull(event, "entity damage event");
    ...
    private final @Nonnull Map<org.bukkit.event.entity.EntityDamageEvent, DamageInfo> eventDamageMapping = Maps.newHashMap();
     ...
     */
    public @Nullable EntityDamageEvent getOurEvent(@Nonnull org.bukkit.event.entity.EntityDamageEvent bukkit) {
     ...
     * @throws NullPointerException if bukkit is null
     */
    public @Nullable EntityDamageEvent setOurEvent(@Nonnull org.bukkit.event.entity.EntityDamageEvent bukkit, @Nullable EntityDamageEvent our) {
        Preconditions.checkNotNull(bukkit, "entity damage event");
    ...
    private final @Nonnull Map<org.bukkit.event.entity.EntityDamageEvent, EntityDamageEvent> eventMapping = Maps.newHashMap();
}
